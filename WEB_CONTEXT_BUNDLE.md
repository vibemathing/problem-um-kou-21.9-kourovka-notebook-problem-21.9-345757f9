...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.9"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-v1",
      "problem_contract_sha256": "52b604363223b83354035c3155008f887f641a61126fdd0377ea20b753ddd0f8",
      "problem_id": "problem:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9",
      "route_id": "route:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-source-fidelity-01",
      "graph_id": "graph:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $F$ be a non-abelian free pro-$p$ group of finite rank. Can one find a finite collection $U_1,\\ldots,U_n$ of open subgroups of $F$, including $F$ itself, such that the only subgroup of $F$ which is contained in $U_i$ and is characteristic in $U_i$ for every $i$ is the trivial subgroup?"
          },
          "statement_sha256": "36aa02963593b73262c5a9fc35f5e070ad25dcb454d2854ba1abe3cce5f8225d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-root",
      "route_id": "route:um-kou-21.9-kourovka-notebook-problem-21.9-345757f9-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.9-739d537b503d",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.9"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
